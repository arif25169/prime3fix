...
function (_Component) {
  ...
  function UITreeNode(props) {
    ...
    _this.onNodeKeyDown = _this.onNodeKeyDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.onDropPointDragOver = _this.onDropPointDragOver.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onDropPointDragEnter = _this.onDropPointDragEnter.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onDropPointDragLeave = _this.onDropPointDragLeave.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
...
_defineProperty(UITreeNode, "propsTypes", {
  node: _propTypes.default.object,
  index: _propTypes.default.number,
  last: _propTypes.default.number,
