...
function (_Component) {
  ...
  function Rating(props) {
    ...
    _this.onStarKeyDown = _this.onStarKeyDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onCancelKeyDown = _this.onCancelKeyDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
...
_defineProperty(Rating, "propsTypes", {
