...
function (_Component) {
  ...
  function OrderListControls() {
    ...
    _this.moveUp = _this.moveUp.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.moveTop = _this.moveTop.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.moveDown = _this.moveDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.moveBottom = _this.moveBottom.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
...
_defineProperty(OrderListControls, "propsTypes", {
