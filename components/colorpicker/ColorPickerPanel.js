...
function (_Component) {
  ...
  function ColorPickerPanel() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ColorPickerPanel).apply(this, arguments));
  }
  ...
  _createClass(ColorPickerPanel, [{
    ...
    value: function renderElement() {
      ...
      var className = (0, _classnames.default)('p-colorpicker-panel', {
...
_defineProperty(ColorPickerPanel, "propsTypes", {
